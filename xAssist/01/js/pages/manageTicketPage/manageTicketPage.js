...
inherits(manageTicketPage, pageParent);

manageTicketPage.prototype.init=function(){
    this.url="client/pages/manageTicketPage/manageTicketPage";
    this.html=null;
    this.index=null;
}
 ...
 * イベント一覧
 */
manageTicketPage.prototype.event=function(){
    var self=this;
    //画面ロード時
    self.showInit();
 ...
 * 画面ロード時
 */
manageTicketPage.prototype.showInit=function(){
    var self=this;
    //プロジェクト取得
    var ajax =new ajaxClass();
    ajax.setUniData("redmineAuth");
...
GLOBAL_PAGE_ARRAY["manageTicketPage"]=new manageTicketPage();
